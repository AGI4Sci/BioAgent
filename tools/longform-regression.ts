...
function expectedArtifactsFromRound(round: DeepRunManifest['rounds'][number] | undefined) {
...
function renderRecordRoundCommand(manifest: DeepRunManifest, round: DeepRunManifest['rounds'][number]) {
  const manifestPath = manifestPathForScenario(manifest.scenarioId);
...
function manifestPathForScenario(scenarioId: string) {
  return join('docs', 'test-artifacts', 'deep-scenarios', scenarioId, 'manifest.json');
}

function renderArtifactEvidenceCommand(manifestPath: string, manifest: DeepRunManifest) {
...
function renderExecutionEvidenceCommand(manifestPath: string, manifest: DeepRunManifest) {
...
function renderBrowserScreenshotCommand(manifestPath: string, manifest: DeepRunManifest) {
...
function renderComputerUseScreenshotCommand(manifestPath: string, manifest: DeepRunManifest) {
